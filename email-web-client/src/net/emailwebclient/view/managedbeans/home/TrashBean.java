...
public class TrashBean extends BaseBean {
	...
	public String init() {
		clearSelection();
		emails = SpringUtil.getServices().getTrashEmails(((SessionBean) JSFUtil.getBean(SessionBean.class.getSimpleName())).getLoggedInUser().getUserId());

		return JSFNavigationConstants.TRASH_PAGE;
	}
